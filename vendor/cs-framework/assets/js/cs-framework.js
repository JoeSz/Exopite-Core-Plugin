...
;(function ( $, window, document, undefined ) {
  ...
  // CSFRAMEWORK GROUP
  // ------------------------------------------------------
  // https://github.com/Codestar/codestar-framework/issues/234
  $.fn.CSFRAMEWORK_GROUP = function() {
    return this.each(function() {
      ...
      $( '.cs-group', _this ).each(function(){
        if ( $( this ).find( '.cs-remove-group' ).length ) {
            $( this ).prepend( '<a href="#" class="clone-group" style="position: absolute;right: 40px;top: 15px;z-index: 2;"><i class="fa fa-clone"></i></a>' );
            $( this ).prepend( '<a href="#" class="cs-remove-group" style="position: absolute;right: 20px;top: 15px;z-index: 2;"><i class="fa fa-remove"></i></a>' );
        };
      ...
      _this.on({
        click: function(e) {
          ...
          // if clicked on clone button
          var clone_parent = $( this ).parent( '.cs-group' );
          if ( clone_parent.length ) {
            clone_group = clone_parent.clone();
          } else {
            clone_group.prepend( '<a href="#" class="clone-group" style="position: absolute;right: 40px;top: 15px;z-index: 2;"><i class="fa fa-clone"></i></a>' );
            clone_group.prepend( '<a href="#" class="cs-remove-group" style="position: absolute;right: 20px;top: 15px;z-index: 2;"><i class="fa fa-remove"></i></a>' );
          }

          var cloned = clone_group.clone().removeClass('hidden');
          field_groups.append(cloned);

          $( '.cs-group', _this ).each( function (i) {
      ...
      field_groups.find('.cs-fieldset').first().on('input', 'input', function(e) {
        var $this = $(this),
            val   = $(this).val(),
            group_title = $(this).closest('.cs-group').find('.cs-group-title'),
            title = $(this).closest('.cs-group').find('.cs-title h4').html();
        group_title.html('<span class="ui-accordion-header-icon ui-icon dashicons dashicons-arrow-right"></span> '+title+': '+val);
      });
